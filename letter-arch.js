...
function storychars() {return [
  { // ANCHOR Aenna #region[red]
    ...
    },
    {
      ...
      conversation: 'Aenna/Davian',
      receiver: 'Davian',
      dateSent: new Date (730, 5, 5),
      dateReceived: new Date (730,5,6),
  ...
  { // ANCHOR Davian #region[green]
    ...
    },
    {
      ...
      receiver: 'Aenna',
      dateSent: new Date (730, 5, 5),
      dateReceived: new Date (730, 5, 10),
    ...
    },
    {
      ...
      conversation: 'Aenna/Davian',
      receiver: 'Aenna',
      dateSent: new Date (730, 6, 6),
      dateReceived: new Date (730, 6, 11),
  ...
  { // ANCHOR Drotan #region[cyan]
    ...
    letters: [
      ...
      },
      {
        ...
        dateReceived: new Date (730, 5, 19),
      ...
      },
      {
        ...
        nextLink: '/pages/Dr-Sk-11',
        prevLink: '/pages/Dr-Sk-9',
        tag: "",
        text: ''
      },
      {
  ...
  { // ANCHOR Niera #region[orange]
    ...
    letters: [{
      ...
      receiver: 'Zephyra',
      dateSent: new Date (730, 3, 22),
      dateReceived: new Date (730, 3, 27),
