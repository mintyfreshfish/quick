function storychars() {
  return [{ // ANCHOR Aenna region[red]
      firstName: 'Aenna',
      lastName: 'Ostodar',
      letters: [{
          id: 'Ae-Da-1',
        ...
        },
        {
          ...
          conversation: 'Aenna/Davian',
          receiver: 'Davian',
          dateSent: new Date(730, 9, 8),
          tag: "Aenna has better things to do than personally deliver money to Davian",
          text: ''
        },
        {
          id: 'Ae-Da-9',
          conversation: 'Aenna/Davian',
          receiver: 'Davian',
          dateSent: new Date(730, 9, 21),
          tag: "Aenna shares the article she wrote about Niera, she will be coming to Onnsel next week",
          text: ''
        },
      ],
    ...
    { // ANCHOR Davian region[green]
      ...
      letters: [{
          ...
          text: 'Aenna, \n You really think I&8216;d stoop low enough to accept anything from you, especially after what you did? No amount of gold would convince me to help you with anything. Ever. Enclosed you&8216;ll find your fifty gold pieces. Though forgive me if I didn&8216;t seal the pouch tightly enough. You know how these lower class tradesmen are. They&8216;ll steal anything they can get their hands on. You should probably send them to the gallows for it. \n I hope you rot in the Abyss,',
    ...
    { // ANCHOR Niera #region[orange]
      ...
      letters: [{
        ...
        },
        {
          ...
          nextLink: '',
          prevLink: '',
          tag: 'very eclectic letter as Niera tries to avoid Idin',
          text: ''
        },
      ],
    ...
    { // ANCHOR Sura #region[purple]
      ...
      letters: [{
        ...
        },
        {
          ...
          conversation: 'Sura/Zephyra',
          receiver: 'Zephyra',
          dateSent: new Date(730, 9, 10),
          tag: "Sura quit work for estate stuff, Torin and Vurmira split up, they need SOMEONE to get married",
          text: '',
        },
        {
          id: 'Su-Ae-1',
          conversation: 'Other',
          receiver: 'Zephyra',
          dateSent: new Date(730, 9, 12),
          tag: "Nasty letter. Aenna is exiled",
          text: '',
        },
      ],
    ...
    { //ANCHOR Zephyra region[cyan]
      ...
      letters: [{
        ...
        },
        {
          ...
          conversation: 'Sura/Zephyra',
          receiver: 'Sura',
          dateSent: new Date(730, 9, 24),
          tag: "Ravvi backstory, Zephyra is working on trade agreements",
          text: '',
        },
        {
          id: 'Ze-Sk-1',
        ...
        },
        {
          ...
          conversation: 'Zephyra/Skeigi',
          receiver: 'Skeigi',
          dateSent: new Date(730, 10, 10),
          tag: "Zephyra is learning theory, official breakup letter, Zephyra swears off men",
          text: '',
        },
        {
          id: 'Ze-Dr-1',
        ...
        },
        {
          ...
          conversation: 'Vurmira/Zephyra',
          receiver: 'Vurmira',
          dateSent: new Date(730, 9, 26),
          tag: "Zephyra doesn't have info on Torin. Gives relationship advice",
          text: '',
        },
        {
          id: 'Ze-Id-1',
          conversation: 'Zephyra/Niera',
          receiver: 'Idin',
          dateSent: new Date(730, 10, 11),
          tag: "Zephyra and Idin have a lot in common as they take care of Ravvi and Niera, respectively",
          text: '',
        },
      ],
      sig: '',
    ...
    { //ANCHOR Rose/Berg region[blue]
      firstName: 'Rose and Berg',
      lastName: '',
      letters: [{
        id: 'RB-Ni-1',
        conversation: 'Other',
        receiver: 'Niera',
        dateSent: new Date(730, 10, 6),
        tag: 'Looking for a piano for Zephyra before Mid-Winter Festival',
        text: ''
      }]
    }, // endregion
    { //ANCHOR Events region[red]
      firstName: 'Events',
      lastName: '',
      letters: [
        {
